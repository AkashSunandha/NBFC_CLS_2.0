...
public class AllScenarios_GroupLoans_GroupLoanCollection_TRANSFER {
	...
	public void groupLoanCollection_CASH(Map<Object, Object> testdata, ITestContext context) throws ClassNotFoundException, InterruptedException, IOException{
		try {
			if(testdata.get("Run").toString().equalsIgnoreCase("Yes")){
				ExtentTestManager.startTest("GroupLoans_GroupLoanCollection_TRANSFER");
				Log.info("GroupLoans_GroupLoanCollection_TRANSFER");
