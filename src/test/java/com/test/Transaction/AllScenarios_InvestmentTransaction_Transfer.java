...
public class AllScenarios_InvestmentTransaction_Transfer extends Base_Class{
...
//				ExtentTestManager.endTest();
				...
				InvstTransaction.SelectTransactionModeDD("TRANSFER");
				InvstTransaction.ClickonPostDebitButton();
				InvstTransaction.postCreditPopUpEntry(testdata);
