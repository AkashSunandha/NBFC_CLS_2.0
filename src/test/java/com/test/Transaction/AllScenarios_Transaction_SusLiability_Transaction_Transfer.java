...
public class AllScenarios_Transaction_SusLiability_Transaction_Transfer {
	...
	public void newCustomer(Map<Object, Object> testdata, ITestContext context) throws ClassNotFoundException, InterruptedException, IOException{
		try {
			if(testdata.get("Run").toString().equalsIgnoreCase("Yes")){
				ExtentTestManager.startTest(testdata.get("TestScenario").toString()+"-Transfer").assignCategory("Suspense Liability Transction -Transfer");
				...
				transSusliability.transactionsSusliability();
				
				transSusliability.susliabilityaccountinfo(testdata, context);
				
				transSusliability.transModeTransfer(testdata, context);
				
				transSusliability.authorizeTransfer(testdata, context);
