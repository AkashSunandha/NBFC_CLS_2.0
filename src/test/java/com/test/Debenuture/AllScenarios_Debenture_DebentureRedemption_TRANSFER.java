...
import com.Page_Debenture.DebentureRedemption;
...
public class AllScenarios_Debenture_DebentureRedemption_TRANSFER {
	...
	public void debentureRedemption_TRANSFER(Map<Object, Object> testdata, ITestContext context) throws ClassNotFoundException, InterruptedException, IOException{
		try {
			if(testdata.get("Run").toString().equalsIgnoreCase("Yes")){
				...
				debRedmMths.debentureRedemptionTransfer();
				
				debRedmMths.authorizeTransfer(testdata, context);
