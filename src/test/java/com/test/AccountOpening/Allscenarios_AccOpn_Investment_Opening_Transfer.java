...
import com.Page_AccountOpening.Investment_Opening_Transfer;
...
public class Allscenarios_AccOpn_Investment_Opening_Transfer {
...
//	Investment_Opening_Cash investment = new Investment_Opening_Cash();
	Investment_Opening_Transfer InsvestmentTransfer = new Investment_Opening_Transfer();
	
	@BeforeSuite
	public void reference() { 
		ExcelReader = new com.Utility.ExcelReader("Investment_Opening_Transfer");
		log = new Log();
	...
	public void newCustomer(Map<Object, Object> testdata, ITestContext context) throws ClassNotFoundException, InterruptedException, IOException{
		try {
			if(testdata.get("Run").toString().equalsIgnoreCase("Yes")){
				...
				InsvestmentTransfer.LoadInvestmentOpeningTranfer(testdata, context);
//			    investment.LoadInvestmentOpeningWindow(testdata, context);
				
				InsvestmentTransfer.authoriseLogin();
