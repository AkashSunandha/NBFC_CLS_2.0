...
import com.Page_Repositary.PageRepository_GL_Account_Transaction;
...
public class GL_Account_Transaction_Transfer extends Base_Class {
	...
	PageRepository_GL_Account_Transaction GLTransaction = new PageRepository_GL_Account_Transaction();
