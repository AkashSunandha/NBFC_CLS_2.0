...
public class PageRepositary_AccOpr_MembMang_MembMang_Deposit {
	...
	public By memberManagementDepositTab = By.xpath("//a[text()='Member Management Deposit ']");	
	//Account Info
...
//	public By variable = By.xpath("");
	...
	public By anmLoaneeTypeDropdown = By.xpath("//*[@id=\"ctl00_ctl00_CPH1_PRDCNT_ddlNature_ddl\"]");
	...
	public By anmCustDetailsGrid = By.xpath("//*[@id=\"CustList\"]//*[@id=\"tblCustViewList\"]");
