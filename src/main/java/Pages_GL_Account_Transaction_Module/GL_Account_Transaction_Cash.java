...
public boolean userLoginValidPaswrd(Map<Object, Object> testdata, ITestContext context)throws ClassNotFoundException, InterruptedException, IOException {
	ExtentTestManager.startTest("TC:01 - Login Functionality").assignCategory("GeneralAccountTransactionCash");
...
public boolean LaunchGLAccountTransactionModule() throws InterruptedException {
	ExtentTestManager.startTest("TC:02 - Launch GL Account Transaction Module").assignCategory("GeneralAccountTransactionCash");
...
public boolean DefaultDateCheck()throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:03 - Default Date Check").assignCategory("GeneralAccountTransactionCash");
...
public boolean DefaultBranchCheck()throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:04 - Default Branch Check").assignCategory("GeneralAccountTransactionCash");
...
public boolean GLAccNameDropdownOptions() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:05 - GL Acc. Name Dropdown Options").assignCategory("GeneralAccountTransactionCash");
...
public boolean GLAccNametoCodeMapping() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:06 - GL Acc. Name to Code Mapping").assignCategory("GeneralAccountTransactionCash");
...
public boolean TransTypeDropdownOptions() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:07 - Trans Type Dropdown Options").assignCategory("GeneralAccountTransactionCash");
...
public boolean GoButtonActionwithValidGLAccCode()throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:08 - Go Button Action with Valid GL Acc. Code").assignCategory("GeneralAccountTransactionCash");
...
public boolean DisplayEntryonCheckboxClick() throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:09 - Display Entry on Checkbox Click").assignCategory("GeneralAccountTransactionCash");
...
public boolean NetPayableandRecoveryCalculation(Map<Object, Object> testdata, ITestContext context) throws InterruptedException, StaleElementReferenceException, TimeoutException {
	...
	ExtentTestManager.startTest("TC:10 - Net Payable and Recovery Calculation").assignCategory("GeneralAccountTransactionCash");
...
public boolean TrnsmodeDropdownValidation() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:11 - Trnsmode Dropdown Validation").assignCategory("GeneralAccountTransactionCash");
...
public boolean GLTransactionCreditandCash() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:12 - GL Transaction - Credit and Cash").assignCategory("GeneralAccountTransactionCash");
...
public boolean EnterPartyNameforTransaction(Map<Object, Object> testdata, ITestContext context) throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:13 - Enter Party Name for Transaction").assignCategory("GeneralAccountTransactionCash");
...
public boolean EnterParticularsforTransaction(Map<Object, Object> testdata, ITestContext context) throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:14 - Enter Particulars for Transaction").assignCategory("GeneralAccountTransactionCash");
...
public boolean GLTransactionsCreditandCash() throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:15 - GL Transaction - Credit and Cash").assignCategory("GeneralAccountTransactionCash");
...
public boolean TransactionSummaryValidation() throws InterruptedException {
	...
	ExtentTestManager.startTest("TC:16 - Transaction Summary Validation").assignCategory("GeneralAccountTransactionCash");
...
public boolean LogintoNBFcApplicationinadifferentuser() throws InterruptedException, IOException{
	...
	ExtentTestManager.startTest("TC:17 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean LogintoNBFcApplicationinadifferentuserlogin() throws InterruptedException, IOException{
	...
	ExtentTestManager.startTest("TC:18 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean LogintoNBFcApplicationinadifferentuserAuthorizeandcancel() throws InterruptedException, IOException{
	...
	ExtentTestManager.startTest("TC:19 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean CashierAuthorisationRefresh() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:20 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean SelectCashierCashTransaction() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:21 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean CashierCashAuthorization() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:22 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean ManagerCashAuthorisation() throws InterruptedException, IOException{
	...
	ExtentTestManager.startTest("TC:23 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean CashAuthorizationRefresh() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:24 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
...
public boolean SelectCashTransactionManagerAuthorisation() throws InterruptedException{
	...
	ExtentTestManager.startTest("TC:25 - Login to NBFc Application in a different user").assignCategory("GeneralAccountTransactionCash");
